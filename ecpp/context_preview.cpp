...
log_define("component.context_preview")

// <%pre>
#line 28 "context_preview.ecpp"
...
static tnt::ComponentFactoryImpl<_component_> Factory("context_preview");

static const char* rawData = "\364\000\000\000\372\001\000\000\374\002\000\000\021\003\000\000%\003\000\000|\003\000"
  "\000\231\003\000\000\233\003\000\000\234\003\000\000\244\003\000\000\340\003\000\000(\004\000\000*\004\000\000e\004"
  "\000\000\234\005\000\000\310\005\000\000@\007\000\000s\007\000\000\246\007\000\000\350\007\000\000\034\010\000\000^"
  "\010\000\000\177\t\000\000\262\t\000\000\345\t\000\000'\n\000\000[\n\000\000\235\n\000\000\302\013\000\000\365\013"
  "\000\000(\014\000\000j\014\000\000\236\014\000\000\340\014\000\000\337\016\000\000\271\017\000\000\325\017\000\000"
  "\006\020\000\000\010\020\000\000X\020\000\000\230\020\000\000\010\021\000\000\021\023\000\000-\023\000\000^\023\000"
  "\000`\023\000\000\260\023\000\000\360\023\000\000`\024\000\000c\026\000\000\177\026\000\000\260\026\000\000\262\026"
  "\000\000\002\027\000\000B\027\000\000\262\027\000\0005\031\000\000\271\031\000\000\344\031\000\000f\032\000\000\201"
  "\032\000\000<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-stric"
  "t.dtd\">\n<html xmlns=\"http://www.w3.org/1999/xhtml\" xml:lang=\"en\">\n  <head>\n    <meta http-equiv=\"Content-Typ"
  "e\" content=\"text/html; charset=utf-8\" />\n    <title></title>\n    <link href=\"/static/vablo.css\" rel=\"styleshe"
  "et\" type=\"text/css\" />\n    <link href=\"/feed/atom\" type=\"application/atom+xml\" rel=\"alternate\" title=\"Atom"
  " feed\" />\n  </head>\n  <body>\n\n  <div id=\"background\">\n    <div id=\"head\">\n\t    <h1><a href=\"/\"></a></h1"
  ">\n    </div>\n    <div id=\"tags\">\n      <dl class=\"tags\">\n        <dt>\n          categories\n        </dt>\n "
  "       <dd>\n          <a href=\"/categories/\">()</a>\n          </dd>\n      </dl>\n    </div>\n    <div id=\"conte"
  "nt\">\n  <div id=\"auth_info\"> \n    <p>Logged in as <a href=\"/admin/user/update/\"></a>\n    | <a href=\"/admin/lo"
  "gout\">Logout</a></p>\n  </div>\n  <div id=\"menu\"> \n    <p>\n      <a href=\"/admin/\">Edit Article</a> <a href=\""
  "/admin/article/new\">New Article</a> |\n      <a href=\"/admin/user/\">User List</a> <a href=\"/admin/user/new\">New "
  "User</a> |\n      <a href=\"/admin/context/\">Edit Context</a> <a href=\"/admin/context/new\">New Context</a>\n    </"
  "p>\n  </div>\n    <div class=\"context\">\n      <h4>Context </h4>\n      <p><form action=\"/admin/context/preview\" "
  "method=\"post\">\n        <table class=\"ctxlist\">\n          <caption>Default&nbsp;object&nbsp;privilegs</caption>"
  "\n          <tr>\n            <td>ReadLevel</td>\n            <td>\n              <input type=\"hidden\" name=\"i_typ"
  "e\" value=\"update_privs\" />\n              <select name=\"i_readlevel\">\n                <option value=\"2\" >Publ"
  "ic</option>\n                <option value=\"8\" >Users</option>\n                <option value=\"14\" >Context unpri"
  "vileged</option>\n                <option value=\"30\" >Owner</option> \n                <option value=\"62\" >Contex"
  "t privileged</option> \n                <option value=\"126\" >Superuser</option> \n              </select>\n        "
  "    </td>\n          </tr>\n          <tr>\n            <td>AddLevel</td>\n            <td>\n              <input typ"
  "e=\"hidden\" name=\"i_type\" value=\"update_privs\" />\n              <select name=\"i_addlevel\">\n                <"
  "option value=\"2\" >Public</option>\n                <option value=\"8\" >Users</option>\n                <option val"
  "ue=\"14\" >Context unprivileged</option>\n                <option value=\"30\" >Owner</option> \n                <opt"
  "ion value=\"62\" >Context privileged</option> \n                <option value=\"126\" >Superuser</option> \n         "
  "     </select>\n            </td>\n          </tr>\n          <tr>\n            <td>WriteLevel</td>\n            <td>"
  "\n              <input type=\"hidden\" name=\"i_type\" value=\"update_privs\" />\n              <select name=\"i_writ"
  "elevel\">\n                <option value=\"2\" >Public</option>\n                <option value=\"8\" >Users</option>"
  "\n                <option value=\"14\" >Context unprivileged</option>\n                <option value=\"30\" >Owner</o"
  "ption> \n                <option value=\"62\" >Context privileged</option> \n                <option value=\"126\" >S"
  "uperuser</option> \n              </select>\n            </td>\n          </tr>\n          <tr>\n            <td>\n  "
  "          </td>\n            <td>\n              <input type=\"submit\" value=\"update\" />\n            </td>\n     "
  "     </tr>\n        </table>\n      </form></p>\n      <p><form action=\"/admin/context/preview\" method=\"post\">\n "
  "       <input type=\"hidden\" name=\"i_type\" value=\"update_urlbase\" />\n        <label for=\"fl_urlbase\">Url base"
  ...
  "    <form action=\"/admin/context/preview\" method=\"post\">\n        <fieldset class=\"singlefield\">\n         <leg"
  "end>Add context admin</legend>\n         <input type=\"hidden\" name=\"i_type\" value=\"add_admin\" />\n         <inp"
  "ut type=\"text\" name=\"i_value\" value=\"\" />\n         <input type=\"submit\" value=\"Add\" />\n        </fieldset"
  ">\n      </form></p>\n    </div>\n  <form action=\"/admin/context/commit\" method=\"get\">\n    <div class=\"submit\""
  "><input type=\"submit\" value=\"Commit\" /></div>\n  </form>\n     </div>\n   </div>\n   <div id=\"footer\">\n     <p"
...
{
  log_trace("context_preview " << qparam.getUrl());

  tnt::DataChunks data(rawData);

  // <%args>
std::string i_type = tnt::stringTo<std::string>("i_type", "std::string", qparam.param("i_type"), reply.out().getloc());
std::string i_value = tnt::stringTo<std::string>("i_value", "std::string", qparam.param("i_value"), reply.out().getloc());
std::string i_readlevel = tnt::stringTo<std::string>("i_readlevel", "std::string", qparam.param("i_readlevel"), reply.out().getloc());
std::string i_addlevel = tnt::stringTo<std::string>("i_addlevel", "std::string", qparam.param("i_addlevel"), reply.out().getloc());
std::string i_writelevel = tnt::stringTo<std::string>("i_writelevel", "std::string", qparam.param("i_writelevel"), reply.out().getloc());
std::string i_urlbase = tnt::stringTo<std::string>("i_urlbase", "std::string", qparam.param("i_urlbase"), reply.out().getloc());
  // </%args>

#line 48 "context_preview.ecpp"
...
#line 193 "inc/context_form.ecpp"
  ...
  // </%include>
  reply.out() << data[56]; //   <form action="/admin/context/commit" method="get">\n    <div class="submit"><input type="submit" value="Commit" /></div>\n  </form>\n
#line 99 "context_preview.ecpp"
  ...
  reply.out() << data[57]; //      </div>\n   </div>\n   <div id="footer">\n
  // <%include> inc/custom_footer.ecpp
  reply.out() << data[58]; //      <p>Served by <a href="http://www.tntnet.org/">tntnet</a> using <a href="http://www.vtoc.de/projects/vablo">vaBlo 0.6</a></p>\n
  // </%include>
  reply.out() << data[59]; //    </div>\n </body>\n</html>\n
  // </%include>
  // <%/cpp>
  return HTTP_OK;
}
