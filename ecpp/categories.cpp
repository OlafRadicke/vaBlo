...
log_define("component.categories")

// <%pre>
#line 28 "categories.ecpp"
...
static tnt::ComponentFactoryImpl<_component_> Factory("categories");
...
{
  log_trace("categories " << qparam.getUrl());

  tnt::DataChunks data(rawData);

  // <%cpp>
#line 38 "categories.ecpp"

  std::string title(vagra::getConfig("vablo", "site_name"));
  std::string search_context = request.getArg("context","default");
  std::string search_category = request.getArg("category");
